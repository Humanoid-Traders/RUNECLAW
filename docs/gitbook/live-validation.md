...
![180-run backtest stress test](live-validation-backtest.png)

The 180-run stress test covers 3 volatility regimes, 3 trend biases, and 20 random seeds. 855 total trades were analyzed across all runs.
