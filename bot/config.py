...
class AnalyzerConfig:
    ...
    # Smart-money-concept voters (default ON): fair value gaps (unfilled gap
    # near price = magnet/support), equal-highs/lows liquidity pools (price
    # is drawn to sweep clustered stops) and premium/discount positioning
